...
public class _05_FirstAndLastGetRow extends DBUtilities {
    ...
    void test1() throws SQLException {
        ...
        int cityId = rs.getInt("city_id"); // We can get all values as a String and then if we need them as number we can convert them.
        // We can also get values as their original type
